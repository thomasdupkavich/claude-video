...
| Surface | Install |
|---------|---------|
| Claude Code | `/plugin marketplace add thomasdupkavich/claude-video` then `/plugin install watch@claude-video` |
| Codex / Cursor / Copilot / +50 | `npx skills add thomasdupkavich/claude-video -g` |
